...
struct SolveKeplerFunc1 : public __unary_function<double, double>
{
	double ecc;
	double M;
...
struct SolveKeplerFunc2 : public __unary_function<double, double>
{
	double ecc;
	double M;
...
struct SolveKeplerLaguerreConway : public __unary_function<double, double>
{
	double ecc;
	double M;
...
struct SolveKeplerLaguerreConwayHyp : public __unary_function<double, double>
{
	double ecc;
	double M;
